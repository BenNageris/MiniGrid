from minigrid.minigrid import Goal, PretendedGoal, Grid, MiniGridEnv, MissionSpace


class GoalEmptyEnv(MiniGridEnv):
    """
    ### Description
    ...
    def _gen_grid(self, width, height):
        ...
        # Place a pretended-goal square in the bottom-right corner
        self.put_obj(PretendedGoal(), 1, height - 2)
